...
A content-based Movie Recommendation System built with Python, Streamlit, and Machine Learning. It recommends similar movies based on genres, keywords, cast, crew, and movie metadata using vectorization techniques, helping users discover movies they are likely to enjoyed. 
